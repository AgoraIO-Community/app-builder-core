            ...
            <View style={style.oAuthContainer}>
              ...
              {$config.ENABLE_GOOGLE_OAUTH ? (
                <TouchableOpacity
                  ...
                  <Text style={[style.secondaryBtnText]}>{useString('google')}</Text>
                </TouchableOpacity>
              ) : (
                <></>
              )}
              {$config.ENABLE_MICROSOFT_OAUTH ? (
                <TouchableOpacity
                  ...
                  <Text style={[style.secondaryBtnText]}>{useString('microsoft')}</Text>
                </TouchableOpacity>
              ) : (
                <></>
              )}
              {$config.ENABLE_SLACK_OAUTH ? (
                <TouchableOpacity
                  ...
                  <Text style={[style.secondaryBtnText]}>{useString('slack')}</Text>
                </TouchableOpacity>
              ) : (
                <></>
              )}
              {$config.ENABLE_APPLE_OAUTH ? (
                <TouchableOpacity
                  ...
                  <Text style={[style.secondaryBtnText]}>{useString('apple')}</Text>
                </TouchableOpacity>
              ) : (
                <></>
              )}
