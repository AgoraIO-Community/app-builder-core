...
const Navbar = (props: any) => {
  ...
  return (
    <View
      onLayout={onLayout}
      style={[Platform.OS === 'web' ? style.navHolder : style.navHolderNative, {backgroundColor: $config.SECONDARY_FONT_COLOR + 80, justifyContent: mobileAndTabletCheck() ? 'space-between' : 'flex-end'}]}>
