        ...
        use: {
          ...
          options: {
            ...
            plugins: [
              ...
              [
                // Using module resolver plugin to alias imports
                'module-resolver',
                {
                  alias: {
              ...
              // Adds react-refresh babel plugin which works along side the webpack plugin
              isDevelopment && [
                require.resolve('react-refresh/babel'),
                {
                  // react-refresh plugin expects the NODE_ENV to development or production
                  // But electron-webpack sets NODE_ENV to renderer or main
                  // So skip env check on electron to avoid conflict
                  skipEnvCheck: isElectron,
                },
              ],
            ].filter(Boolean),
          },
